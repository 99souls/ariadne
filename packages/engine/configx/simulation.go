...
func (s *Simulator) Simulate(current, candidate *EngineConfigSpec) *SimulationImpact {
	...
	if current == nil && candidate != nil {
		impact.ChangedFields = countNonNilSections(candidate)
	}
	if current != nil && candidate != nil {
		impact.ChangedFields = diffSectionCount(current, candidate)
	}
...
func ruleDelta(a, b *EngineConfigSpec) int {
	...
	if a != nil && a.Policies != nil {
		ac = len(a.Policies.BusinessRules)
	}
	if b != nil && b.Policies != nil {
		bc = len(b.Policies.BusinessRules)
	}
	return bc - ac
}
...
func diffFlags(a, b *EngineConfigSpec) (added, removed []string) {
	...
	if a != nil && a.Policies != nil && a.Policies.EnabledFlags != nil {
		for k := range a.Policies.EnabledFlags {
			am[k] = true
		}
	}
	if b != nil && b.Policies != nil && b.Policies.EnabledFlags != nil {
		for k := range b.Policies.EnabledFlags {
			bm[k] = true
		}
	}
	for k := range bm {
