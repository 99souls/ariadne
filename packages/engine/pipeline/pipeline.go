...
func (p *Pipeline) processContent(page *engmodels.Page) *engmodels.CrawlResult { time.Sleep(5 * time.Millisecond); if page != nil { page.ProcessedAt = time.Now() }; resultURL := ""; if page != nil && page.URL != nil { resultURL = page.URL.String() }; return &engmodels.CrawlResult{ URL: resultURL, Page: page, Success: true, Stage: "processing" } }
